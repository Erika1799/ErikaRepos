...
namespace SistemaBibliotecaVirtualSBV
{
    public partial class FormUsuario : Form
    {
        ...
        {
            string con = "Data Source=LENOVOL340;Initial Catalog=Biblioteca;Integrated Security=True";
            return con;
        }
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=LENOVOL340;Initial Catalog=Biblioteca;Integrated Security=True");
